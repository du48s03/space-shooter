#define perp_speed
///perp_speed(obj1, obj2, array)
//find the perpendicular speed of obj1 towards obj2 and stores it in array
var obj1 = argument[0];
var obj2 = argument[1];
...
array[@ 1] = (obj1.hspeed*dx+obj1.vspeed*dy) /(dx*dx+dy*dy)*dy;
array[@ 0] = (obj1.hspeed*dx+obj1.vspeed*dy) /(dx*dx+dy*dy)*dx;
